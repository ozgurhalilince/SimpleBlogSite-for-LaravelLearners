...
<head>
  ...
  <meta name="author" content="Özgür Halil İNCE" />
...
<div class="login-box">
  <div class="login-logo">
    <a href="/theme/index2.html"><b>Yönetici Girişi</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form class="login-form fade-in-effect" role="form" method="POST" action="{{ url('/login') }}" id="login">
      {{ csrf_field() }}
